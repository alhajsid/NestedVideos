package com.dbm.meest4bharat.Widget;
...
import com.dbm.meest4bharat.Adapters.CampaignDraftedAdapter;
import com.dbm.meest4bharat.R;
import com.dbm.meest4bharat.Responses.CampaignDraftedResponse;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        CampaignDraftedAdapter.ViewHolder holder = (CampaignDraftedAdapter.ViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
...
//        }
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                requestManager.load(R.drawable.discover_volume_off)
                        .into(volumeControl);
            }
            else if(volumeState == VolumeState.ON){
                requestManager.load(R.drawable.discover_volume_on)
                        .into(volumeControl);
            }
